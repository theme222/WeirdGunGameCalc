...
const pages = [
  ...
  `In the results section. There will be a button called "Stats to Compare," which will open a menu to select the details you want to show of that gun. By default, it will show the stats that I think are commonly useful (TTK, damage, spread, range, magazine size, recoil, speed, and health).`,
  `When using the calculator. It may be tempting to blindly trust the results. However, more often than not, the calculator will output something that is perfect except for one stat. Make sure to filter all the stats you care about and check the stat details. It is also common that semi-auto cores will show up, so make sure to ban them as well.`,
