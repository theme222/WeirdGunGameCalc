...
export const filterDescriptions: {[key in typeof filterTitles[number]]: string} = {
  ...
  "Ban Firing Mode": "Ban the calculator from using a list of firing modes",
  ...
  "Default Max Health": "The player's maximum health to use for TTK calculations",
  ...
  "Force Firing Mode": "Force the calculator to use a list of firing modes",
